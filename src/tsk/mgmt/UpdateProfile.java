...
import java.sql.*;
class UpdateProfile extends JPanel implements ActionListener, KeyListener
{
	JRadioButton r1 = new JRadioButton("Male");
	JRadioButton r2 = new JRadioButton("Female");
	ButtonGroup gender = new ButtonGroup();
	JLabel l1=new JLabel("UPDATE PROFILE");
	...
	public void addPanel()
	{
        ...
        if(bc)
        {
        	...
        	{
        		JOptionPane.showMessageDialog(new UpdateProfile(), e, "Error", JOptionPane.WARNING_MESSAGE);
        	}
        }
		p.add(l1);
		add(p);
				...
				if(cv==true)
				{
					...
					if(b==true)
					{
						...
						try
						{
							...
							stmt.setString(2, g);									//Gender
							stmt.setString(3,(String) date.getSelectedItem());		//Date
							stmt.setString(4,(String) month.getSelectedItem());		//Month
							stmt.setString(5,(String) year.getSelectedItem());		//Year
							...
							stmt.setString(12, Database.login_uid);					//UID
							stmt.executeUpdate();
							JOptionPane.showMessageDialog(null,"Information Updated Successfully");
						}
						catch(Exception exx)
						{
							JOptionPane.showMessageDialog(new UpdateProfile(), exx, "Error", JOptionPane.WARNING_MESSAGE);
						}
					}
				}
			}
